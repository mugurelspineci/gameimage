  ...
  <div class="mainA">
	...
	<div class="pBody">
		...
		<div class="pCenter">	
			...
			<div align="center">
				<img src="images/0438.jpg" width="550" height="400" />
				</div>	 
			<div>
				<!-- Hydraulic -->
				 <?php include("pageHydraulic.php") ?>   
				<!-- End Hydraulic -->
			</div>			
		  </div>	
		  <!-- end div.bgBrown-->
		  <div align="center">
			<img src="image_layout/Quality.jpg" alt="Quality is our business" width="180" height="20" /></div>
  		</div>
 <!-- end center -->
 </div>
 <!-- end body -->
